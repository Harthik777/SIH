  ...
  return (
    <section className="panel trust-panel">
      ...
      <div className="trust-grid">
        ...
        <div><span><BrainCircuit size={16}/></span><small>GRAPHSAGE</small><strong>{modelReady ? 'READY' : 'REVIEW'}</strong><em>{modelReady ? 'reproduced · F1 1.00' : 'fallback mode active'}</em></div>
