...
const evaluation: SurakshaEvaluation = {
  ...
  summary: { entities_recovered: 12, entities_expected: 12, relationships_recovered: 5, relationships_expected: 5, hidden_path_recovered: true, false_merges: 0, processing_mode: 'deterministic-local' },
